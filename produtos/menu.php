...
<ul>
  <li><a href="../produtos.php">Apresentação</a></li>
  <li><a href="pontes-rolantes.php">Pontes Rolantes</a></li>
  ...
  <li><a href="a-prova-de-explosao.php">À Prova de Explosão <img src="../img/ex.png" width="17px" height="15px" border=none></a></li>
</ul>