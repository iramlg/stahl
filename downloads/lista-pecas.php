        ...
        <div id="container">
            <div id="sidebar">
                ...
                <ul>
                    ...
                    <li id="ativo">Lista de Peças</li>
                    <li><a href="catalogos.php">Catálogos / Folders</a></li>
                </ul>
                <div id="banner"> </div>
            </div>
            ...
            <div id="mainContent">
                ...
                <div id="sidebar1"> </div>
                <div id="conteudo">
                    <h2>Manuais de Manutenção</h2>
                    <div class="downloadp">
                        <h2>1.Talhas de Corrente</h2>
                        <h3>- Talhas de corrente tipo  R</h3>
                        <ul class="pdf_download">
                            <li>- Modelo R6 <a href="/downloads/Lista_Pecas_R6.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo R20 <a href="/downloads/Lista_Pecas_R20.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                        </ul>
                        <h3>- Talhas de corrente tipo T </h3>
                        <ul class="pdf_download">
                            <li>- Modelo T2 <a href="/downloads/modelo_T2.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo T3 <a href="/downloads/modelo_T3.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo T4 <a href="/downloads/modelo_T4.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo T5 <a href="/downloads/modelo_T5.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo T6 <a href="/downloads/modelo_T6.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                        </ul>
                        <h3>- Talhas de Corrente tipo ST</h3>
                        <ul class="pdf_download">
                            <li>- Modelo ST 05 <a href="/downloads/modelo_ST_05.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo ST 10 <a href="/downloads/modelo_ST_10.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo ST 20 / ST 30 <a href="/downloads/modelo_ST_20-30.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo ST 32 / 50 / 60  <a href="/downloads/modelo_ST_32-50-60.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                        </ul>
                        <h2>2.Talhas de Cabo de A&ccedil;o</h2>
                        <h3>-<strong> Talha de Cabo de Aço tipo AS</strong></h3>
                        <ul class="pdf_download">
                            <li>- Modelo AS 20 <a href="/downloads/as20_ol.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo AS 30&nbsp;<a href="/downloads/as30_ol.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo AS 40 <a href="/downloads/modelo_AS_40.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo AS 50 <a href="/downloads/modelo_AS_50.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo AS 60 <a href="/downloads/modelo_AS_60.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo AS 70 <a href="/downloads/modelo_AS_70.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                        </ul>
                        <h3>- Talhade Cabo de A&ccedil;o tipo SH</h3>
                        <ul class="pdf_download">
                            <li>- Modelo SH 20 <a href="/downloads/sh2_ol.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo SH 30 <a href="/downloads/modelo_SH_30.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo SH 40 <a href="/downloads/modelo_SH_40.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo SH 50 <a href="/downloads/modelo_SH_50.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                            <li>- Modelo SH 60&nbsp;<a href="/downloads/modelo_SH_60.pdf" target="_blank">
                                    <div class="bt_donwload"></div>
                                </a></li>
                        </ul>
                    </div>
